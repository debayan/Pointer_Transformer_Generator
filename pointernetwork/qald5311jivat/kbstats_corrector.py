...
for idx,item in enumerate(d):
    ...
    if resulttarget == resultanswer:
        ...
        print("nomatch")
        nem += 1
        querywrong.append({'queryans':answer,'querytar':target,'id':str(item['uid']),'question':item['question'],'ents':ents,'rels':rels,'resulttarget':resulttarget,'resultanswer':resultanswer})
