...
tf.app.flags.DEFINE_integer("max_input_sequence_len1", 500, "Maximum input sequence length.")
tf.app.flags.DEFINE_integer("max_output_sequence_len1", 500, "Maximum output sequence length.")
