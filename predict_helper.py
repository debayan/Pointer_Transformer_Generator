...
#            for answer1stpass,answer2ndpass,target1stpass,uid,question1stpass,question2ndpass in zip(output1,output2,labels["dec_target"],testfeatures["uid"],features["question"],questions):
#                answerclean1stpass = answer1stpass[1:]
...
#                totalfuzz2ndpass += fuzz.ratio(target1stpass_.lower(), answer2ndpass_.lower())
#                qcount2ndpass += 1
#                print("2nd pass question: ", question2ndpass)
#                print("1st pass target: ", target1stpass_)
#                print("1st pass answer: ", answer1stpass_)
#                print("2nd pass answer: ", answer2ndpass_)
#                print("1st pass fuzz: ", fuzz.ratio(target1stpass_.lower(), answer1stpass_.lower()))
#                print("2nd pass fuzz: ", fuzz.ratio(target1stpass_.lower(), answer2ndpass_.lower()))
#                
