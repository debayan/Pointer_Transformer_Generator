...
def main():
        ...
        parser.add_argument("--model_depth", default=350, help="Model Embedding size", type=int)
        ...
        parser.add_argument("--max_epochs", default=10, help="Max epochs during training", type=int)
